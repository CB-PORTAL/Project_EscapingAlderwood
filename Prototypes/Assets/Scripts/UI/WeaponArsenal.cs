...
namespace DuRound
{
    ...
    {
        public enum CurrentWeapon { None,Melee, Range};
        ...
        //call from button
        public void Slot1Select() { if (!slot1.enabled) return; slot1Parent.color = Color.red; slot2Parent.color = Color.black; slot3Parent.color = Color.black; slot4Parent.color = Color.black; slot1Select = true; slot2Select = false; slot3Select = false; slot4Select = false; currentWeapon = CurrentWeapon.Melee; }
        public void Slot2Select() { if (!slot2.enabled) return; slot2Parent.color = Color.red;  slot1Parent.color = Color.black; slot3Parent.color = Color.black; slot4Parent.color = Color.black; slot1Select = false; slot2Select = true; slot3Select = false; slot4Select = false; currentWeapon = CurrentWeapon.Range; }
        ...
        public void InsetSlot1(Sprite sprite) { slot1.sprite = sprite; slot1.enabled = true;Slot1Select(); }
        public void InsetSlot2(Sprite sprite) { slot2.sprite = sprite; slot2.enabled = true;Slot2Select(); }
